...
impl Renderer {
    ...
    fn draw_tab_bar_static(
        ...
        let theme_btn_padding: u32 = 8;
        let theme_btn_width: u32 =
            (theme_name.len() as u32) * (cell_size.width as u32) + theme_btn_padding * 2;
        ...
        // Accent underline for the theme button
        Self::fill_rect_static(
            buffer,
            theme_btn_x,
            (tab_bar_height - 2) as i32,
        ...
        // Separator to the left of the theme button
        Self::fill_rect_static(
            buffer,
            theme_btn_x,
            4,
        ...
        let theme_text_x = theme_btn_x + theme_btn_padding as i32;
